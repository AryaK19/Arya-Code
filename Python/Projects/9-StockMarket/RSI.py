...
def RSI(ticker_NS, Dict, ticker):
    ...
    Dict.update(
        {str(ticker): [datalast, dataprev2, dataprev3, dataprev4, dataprev5]})
...
for key, value in Dict.items():
    if (value[0] >= 68) and ((value[0] < value[1] < value[2]) or (value[0] < value[2])):
        sell.append(f"{key} : {value[0]}")

    elif (value[0] <= 30) and ((value[0] > value[1] > value[2]) or (value[0] > value[2])):
        buy.append(f"{key} : {value[0]}")

    elif (value[0] < value[1] < value[2] < value[3] < value[4]) or (
            value[0] < value[2] < value[3] <
            value[4]) or (value[0] < value[1] < value[3] < value[4]) or (
            value[0] < value[1] < value[2] <
            value[4]) or (value[0] < value[1] < value[2] <
            value[3]) or (value[0] < value[1] < value[2]) or (
            value[0] < value[2] <
            value[3]) or (value[0] < value[1] < value[3]) or (
            value[0] < value[2] <
            value[4]) or (value[0] < value[1] < value[4]) or (
            value[0] < value[3] <
            value[4]) or (value[1] < value[2] < value[3]) or (
            value[1] < value[2] <
            value[4]) or (value[1] < value[3] < value[4]):
