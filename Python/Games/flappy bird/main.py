...
a = pygame.image.load("gallery\\sprites\\bird.png")
    ...
    while True:
        for event in pygame.event.get():
            if event.type == QUIT or (event.type == KEYDOWN and event.key == K_ESCAPE):
                ...
                SCREEN.blit(GAME_SPRITES['message1'],(50 , 40))
                SCREEN.blit(GAME_SPRITES['base'],(base_x ,GROUNDY ))
                SCREEN.blit(GAME_SPRITES['message2'],( 75, SCREENHEIGHT - 80 ))
                SCREEN.blit(GAME_SPRITES['message3'],( 47,140 ))
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird With Arya')
