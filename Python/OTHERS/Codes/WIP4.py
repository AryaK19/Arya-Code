            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                    if event.button == 1:
                        ...
                        while press:
                            ...
                            if POS[0] > 200 and POS[0] < 220 and POS[1] >= 20 and POS[1] <= 200:
                                POSx = (POS[1]//5) * 5
                                pygame.draw.rect(window, "black", (200,POSx,20,5))
                            if POS[0] > 400 and POS[0] < 420 and POS[1] >= 20 and POS[1] <= 200:
                                POSx = (POS[1]//5) * 5
                                pygame.draw.rect(window, "black", (400,POSx,20,5))
                            if POS[0] > 200 and POS[0] < 400 and POS[1] >= 100 and POS[1] <= 120:
                                POSy = (POS[0]//5) * 5
